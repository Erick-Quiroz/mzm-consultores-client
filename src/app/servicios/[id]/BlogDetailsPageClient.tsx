...
export default function BlogDetailsPage({
  ...
  useEffect(() => {
    const fetchPost = async () => {
      try {
        const response = await Get_Service_ById(params.id);
  ...
  return (
    <section className="p-2 md:p-5 lg:p-10 mt-15   ">
      <div className="px-4">
            ...
            <div className="mt-12">
              ...
              <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <Badge variant="outline">{post.tipoServicio.nombre}</Badge>
                </div>
